...
public class DeploymentScenario {
    private String deploymentScenarioValue;

    public DeploymentScenario(String scenario) {
        this.deploymentScenarioValue = scenario;
    }

    public String toString() {
        return this.deploymentScenarioValue;
    }
}
